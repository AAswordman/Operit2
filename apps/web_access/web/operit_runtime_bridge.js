...
(function () {
    ...
    function installPairingWebRuntime(baseUrl, token) {
        if (token.length === 0) {
    ...
    async function webAccessSession(baseUrl, token) {
    ...
    function readPersistedWebAccessSession(baseUrl) {
    ...
    async function pairWebAccessSession(baseUrl, token) {
