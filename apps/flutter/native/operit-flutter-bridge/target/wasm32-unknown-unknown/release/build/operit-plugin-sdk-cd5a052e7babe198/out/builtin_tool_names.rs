...
pub enum BuiltinToolName {
    ...
    /// Selects the `call_chat_model` built-in tool.
    CallChatModel,
    /// Selects the `list_character_cards` built-in tool.
    ListCharacterCards,
    /// Selects the `get_chat_messages` built-in tool.
    GetChatMessages,
    /// Selects the `get_chat_messages_range` built-in tool.
...
impl BuiltinToolName {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CallChatModel => "call_chat_model",
            Self::ListCharacterCards => "list_character_cards",
            Self::GetChatMessages => "get_chat_messages",
            Self::GetChatMessagesRange => "get_chat_messages_range",
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        match name {
            ...
            "call_chat_model" => Some(Self::CallChatModel),
            "list_character_cards" => Some(Self::ListCharacterCards),
            "get_chat_messages" => Some(Self::GetChatMessages),
            "get_chat_messages_range" => Some(Self::GetChatMessagesRange),
    ...
    pub fn accepts_runtime_result(self, result: &ToolResultData) -> bool {
        match self {
            ...
            Self::CallChatModel => matches!(result, ToolResultData::ChatCallResultData(_)),
            ...
            Self::GetChatMessagesRange => matches!(result, ToolResultData::ChatMessagesResultData(_)),
