...
impl ChatHost for AIToolHandler {
    ...
    /// Executes the canonical `Chat.getMessagesRange` Tools binding.
    fn getMessagesRange (& self , chatId : String , options : Option < ChatHostGetMessagesRangeOptions > ,) -> JsFuture < ChatMessagesResultData > {
        invoke_generated(
            self,
    ...
    /// Executes the canonical `Chat.call` Tools binding.
