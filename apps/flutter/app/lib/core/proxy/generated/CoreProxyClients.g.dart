...
class GeneratedApplicationPackageManagerCoreProxy {
  ...
  Future<ToolPkgLogoBytes?> readToolPkgLogoBytes({required String packageName}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'readToolPkgLogoBytes',
        args: _coreProxyArgs(<String, Object?>{'packageName': packageName}, objectArgs),
      ),
    );
    return decodeNativeCoreResult<ToolPkgLogoBytes?>(responseBytes, decode: (reader) => reader.readNullable<ToolPkgLogoBytes>(() => ToolPkgLogoBytes.fromMessagePack(reader)), targetObjectId: objectId, embeddedStreamFactory: bridge.openEmbeddedCoreStream);
  }

  /// Returns enabled ToolPkg context-menu items applicable to one message sender.
  Future<List<ToolPkgChatMessageMenuItem>> getToolPkgChatMessageMenuItems({required String sender, required bool useEnglish}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'getToolPkgChatMessageMenuItems',
        args: _coreProxyArgs(<String, Object?>{'sender': sender, 'useEnglish': useEnglish}, objectArgs),
      ),
    );
    return decodeNativeCoreResult<List<ToolPkgChatMessageMenuItem>>(responseBytes, decode: (reader) => (() { final length = reader.readArrayLength(); return List<ToolPkgChatMessageMenuItem>.generate(length, (_) => ToolPkgChatMessageMenuItem.fromMessagePack(reader), growable: false); })(), targetObjectId: objectId, embeddedStreamFactory: bridge.openEmbeddedCoreStream);
  }

  /// Executes one enabled ToolPkg chat message context-menu item.
  Future<String?> invokeToolPkgChatMessageMenuItem({required String containerPackageName, required String itemId, required String chatId, required int messageIndex, required Object? message}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'invokeToolPkgChatMessageMenuItem',
        args: _coreProxyArgs(<String, Object?>{'containerPackageName': containerPackageName, 'itemId': itemId, 'chatId': chatId, 'messageIndex': messageIndex, 'message': message}, objectArgs),
      ),
    );
    return decodeNativeCoreResult<String?>(responseBytes, decode: (reader) => reader.readNullable<String>(() => reader.readString()), targetObjectId: objectId, embeddedStreamFactory: bridge.openEmbeddedCoreStream);
  }
...
class GeneratedPreferencesModelConfigManagerCoreProxy {
  ...
  Future<ThinkingSettingsDescriptor> getThinkingSettingsForProvider({required String providerId, required String modelId}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'getThinkingSettingsForProvider',
        args: _coreProxyArgs(<String, Object?>{'providerId': providerId, 'modelId': modelId}, objectArgs),
      ),
    );
    return decodeNativeCoreResult<ThinkingSettingsDescriptor>(responseBytes, decode: (reader) => ThinkingSettingsDescriptor.fromMessagePack(reader), targetObjectId: objectId, embeddedStreamFactory: bridge.openEmbeddedCoreStream);
  }

  /// Updates the selected thinking option for one provider/model pair.
  Future<ProviderProfile> updateThinkingOptionForProvider({required String providerId, required String modelId, required String thinkingOptionId}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'updateThinkingOptionForProvider',
        args: _coreProxyArgs(<String, Object?>{'providerId': providerId, 'modelId': modelId, 'thinkingOptionId': thinkingOptionId}, objectArgs),
      ),
    );
    return decodeNativeCoreResult<ProviderProfile>(responseBytes, decode: (reader) => ProviderProfile.fromMessagePack(reader), targetObjectId: objectId, embeddedStreamFactory: bridge.openEmbeddedCoreStream);
  }
...
class GeneratedServerRuntimeRemoteLinkServiceCoreProxy {
  ...
  Future<NetworkControlState> bootstrapDeviceSpaceControl() async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'bootstrapDeviceSpaceControl',
        args: _coreProxyArgs(const <String, Object?>{}, objectArgs),
      ),
    );
    return decodeNativeCoreResult<NetworkControlState>(responseBytes, decode: (reader) => NetworkControlState.fromMessagePack(reader), targetObjectId: objectId, embeddedStreamFactory: bridge.openEmbeddedCoreStream);
  }

  /// Returns current identity definitions, device assignments, and removal state.
  Future<NetworkControlState> deviceSpaceControl() async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'deviceSpaceControl',
        args: _coreProxyArgs(const <String, Object?>{}, objectArgs),
      ),
    );
    return decodeNativeCoreResult<NetworkControlState>(responseBytes, decode: (reader) => NetworkControlState.fromMessagePack(reader), targetObjectId: objectId, embeddedStreamFactory: bridge.openEmbeddedCoreStream);
  ...
  Future<List<NetworkControlAuditRecord>> deviceSpaceControlAudit() async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'deviceSpaceControlAudit',
        args: _coreProxyArgs(const <String, Object?>{}, objectArgs),
      ),
    );
    return decodeNativeCoreResult<List<NetworkControlAuditRecord>>(responseBytes, decode: (reader) => (() { final length = reader.readArrayLength(); return List<NetworkControlAuditRecord>.generate(length, (_) => NetworkControlAuditRecord.fromMessagePack(reader), growable: false); })(), targetObjectId: objectId, embeddedStreamFactory: bridge.openEmbeddedCoreStream);
  }

  /// Defines one custom role from named capabilities.
  Future<void> defineDeviceSpaceRole({required NetworkControlRole role}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'defineDeviceSpaceRole',
        args: _coreProxyArgs(<String, Object?>{'role': role.toJson()}, objectArgs),
      ),
    );
    decodeNativeCoreVoidResult(responseBytes);
  }
  ...
  Future<void> setDeviceSpaceIdentity({required NetworkControlIdentityAssignment assignment}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'setDeviceSpaceIdentity',
        args: _coreProxyArgs(<String, Object?>{'assignment': assignment.toJson()}, objectArgs),
      ),
    );
    decodeNativeCoreVoidResult(responseBytes);
  }
  ...
  Future<void> clearDeviceSpaceIdentity({required String nodeId}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'clearDeviceSpaceIdentity',
        args: _coreProxyArgs(<String, Object?>{'nodeId': nodeId}, objectArgs),
      ),
    );
    decodeNativeCoreVoidResult(responseBytes);
  }
  ...
  Future<void> updateDeviceSpacePolicy({required String policyId, required String value}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'updateDeviceSpacePolicy',
        args: _coreProxyArgs(<String, Object?>{'policyId': policyId, 'value': value}, objectArgs),
      ),
    );
    decodeNativeCoreVoidResult(responseBytes);
  }
  ...
  Future<void> admitDeviceSpaceMember({required String deviceId}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'admitDeviceSpaceMember',
  ...
  Future<void> removeDeviceSpaceMember({required String deviceId}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'removeDeviceSpaceMember',
        args: _coreProxyArgs(<String, Object?>{'deviceId': deviceId}, objectArgs),
      ),
    );
    decodeNativeCoreVoidResult(responseBytes);
  ...
  Future<void> disconnectDeviceSpaceNode({required String deviceId}) async {
    final responseBytes = await bridge.callBytes(
      CoreCallRequest(
        requestId: _coreProxyRequestId(),
        targetObjectId: objectId,
        methodName: 'disconnectDeviceSpaceNode',
        args: _coreProxyArgs(<String, Object?>{'deviceId': deviceId}, objectArgs),
      ),
    );
    decodeNativeCoreVoidResult(responseBytes);
