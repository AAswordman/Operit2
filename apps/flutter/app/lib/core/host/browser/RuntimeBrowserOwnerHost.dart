...
import 'package:operit2/ui/features/chat/components/workspace/browser/chrome/WorkspaceBrowserExternalNavigationDialog.dart';
import 'package:operit2/ui/features/chat/components/workspace/browser/chrome/WorkspaceBrowserJavaScriptDialogs.dart';
import 'package:operit2/ui/features/chat/components/workspace/browser/permissions/WorkspaceBrowserPermissionDialog.dart';
...
class RuntimeBrowserOwnerHost extends StatefulWidget {
  const RuntimeBrowserOwnerHost({
    super.key,
    required this.child,
  ...
  @override
  State<RuntimeBrowserOwnerHost> createState() =>
      _RuntimeBrowserOwnerHostState();
}

class _RuntimeBrowserOwnerHostState extends State<RuntimeBrowserOwnerHost> {
  final RuntimeBrowserSessionRegistry _registry =
      RuntimeBrowserSessionRegistry.instance;
  final RuntimeBrowserOwner _browserSessionStore = RuntimeBrowserOwner.instance;
  ...
  @override
  void didUpdateWidget(covariant RuntimeBrowserOwnerHost oldWidget) {
  ...
  /// Attaches owner WebView prompts after inherited widgets are available.
  @override
  ...
  @override
  void dispose() {
    _browserSessionStore.detachOwnerUi(this);
    _disable();
    super.dispose();
  }
  ...
  /// Connects runtime-owner WebView prompts to this application host.
  void _attachOwnerUi() {
    _browserSessionStore.attachOwnerUi(
      owner: this,
      delegate: RuntimeBrowserOwnerUiDelegate(
  ...
  /// Confirms and opens a non-WebView navigation in the owner application.
  ...
  /// Resolves a real owner WebView permission request in the owner application.
  Future<void> _handlePermissionRequest(
    ...
    if (allowed == true) {
      _browserSessionStore.permissions.record(
        origin: origin,
  ...
  RuntimeBrowserAutomationController _controller(
    BrowserAutomationRequest request,
  ) {
  ...
  Widget build(BuildContext context) {
    return RuntimeBrowserOwnerSurfaceHost(child: widget.child);
  }
}
