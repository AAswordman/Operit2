...
use crate::javascript::JsToolPkgRegistration::{
...
fn nativeInvokeToolPkgIpcStrings(
    ...
    let resolved = CURRENT_TOOL_HANDLER.with(|handler| -> Result<(crate::core::tools::javascript::JsEngine::JsEngine, String, String, String, String), String> {
