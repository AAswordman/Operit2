...
use operit_tools::ToolPackage::LocalizedText;
...
impl ToolPkgMainRegistrationScriptParser {
    ...
    fn parseWithTextResourcesInternal(
        ...
        let capturedResult: Result<
            crate::javascript::JsToolPkgRegistration::ToolPkgMainRegistrationCapture,
            String,
...
fn parseCapturedRegistration(
    captured: crate::javascript::JsToolPkgRegistration::ToolPkgMainRegistrationCapture,
    toolPkgId: &str,
...
mod tests {
    use super::*;
    use crate::javascript::JsToolPkgRegistration::ToolPkgMainRegistrationCapture;
