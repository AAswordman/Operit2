...
"call": __operitToolPkgApi.method().since("2.0.0", function(options) {
    return __operitInvokeToolsBinding("Chat", "call", "call_chat_model", [["options"]], Array.prototype.slice.call(arguments));
}),
...
"getMessagesRange": function(chatId, options) {
    return __operitInvokeToolsBinding("Chat", "getMessagesRange", "get_chat_messages_range", [["chatId", "options"]], Array.prototype.slice.call(arguments));
},
"listAll": function() {
