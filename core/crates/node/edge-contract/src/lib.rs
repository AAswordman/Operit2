/// Numeric object id reserved for the Edge device I/O service namespace.
pub const EDGE_DEVICE_IO_OBJECT_ID: u32 = 1;

/// Link property name used by the digital-output state watch.
pub const EDGE_DEVICE_IO_STATE_PROPERTY: &str = "digitalOutputState";

/// Numeric object id reserved for the Edge robot face service namespace.
pub const EDGE_ROBOT_FACE_OBJECT_ID: u32 = 2;
