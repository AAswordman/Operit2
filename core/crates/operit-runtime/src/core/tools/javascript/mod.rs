...
#[path = "JsComposeDslBridge.rs"]
pub mod JsComposeDslBridge;

#[path = "JsComposeDslRuntimeScript.rs"]
pub mod JsComposeDslRuntimeScript;

#[path = "JsEmbeddedLibraryLoader.rs"]
pub mod JsEmbeddedLibraryLoader;

#[path = "JsExecutionResultProtocol.rs"]
pub mod JsExecutionResultProtocol;
...
#[path = "JsToolPkgRegistration.rs"]
pub mod JsToolPkgRegistration;
