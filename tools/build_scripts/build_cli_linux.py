...
# Parses command-line options for the Linux CLI build.
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Operit2 CLI for Linux.")
...
# Builds the Linux CLI package with the selected asset mode.
def main() -> int:
    args = parse_args()
    build_cli_platform(
        "linux",
